                ...
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="flex items-center justify-between md:p-3 border-b border-b-gray-100 rounded-t">
                        ...
                        <div className="flex justify-end items-center">
                            ...
                            <button onClick={handleRefresh} type="button" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="default-modal">
                    ...
                    {/* Modal body */}
                    {
                        success ? <div className="px-4 py-2.5 mb-1 text-sm text-green-800 bg-green-50 " role="alert">
                            New Role Created  <span className="font-medium">Successfully!</span>
                        </div> : null
                    }
                    {
                        error ?
                    ...
                    <form onSubmit={createRole}>
                        ...
                        <div className="flex items-center px-4 pb-4 md:px-5 rounded-b">
                            <button data-modal-hide="static-modal" type="submit" className="text-white bg-[#103d15] hover:bg-[#ff9c40] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center">Submit</button>
                        </div>
                    </form>
