                ...
                <div className="relative p-4 w-full max-w-2xl max-h-full">
                    ...
                    <div className="relative bg-white rounded-lg shadow ">
                        ...
                        <div className="flex items-center justify-between md:p-3 border-b border-b-gray-100 rounded-t">
                            <div>
                                <p className="font-semibold text-xl font-[Roboto]">Product Details</p>
                            </div>
                            ...
                            <ul className="pl-3 py-2">
                                <li className="mb-2">
                                    <div className="flex">
                                        ...
                                        <p className="pl-3 text-lg capitalize">
                                ...
                                <li className="mb-2">
                                    <div className="flex">
                                        ...
                                        <p className="pl-3">
                                            {props.holdAllproducts.manufacturer}
                                        </p>
                                    </div>
                                </li>
                                <li className="mb-2">
                                ...
                                <li className="mb-2">
                                    <div className="flex justify-start items-center">
                                        ...
                                        <div  className="bg-green-100 ml-2 text-green-800 text-xs font-[600] h-[20px]  px-2.5  rounded dark:bg-gray-700 dark:text-green-400 border border-green-400">
                                            {props.holdAllproducts.condition}
                                        </div>
                                    </div>
                                </li>
                            </ul>
